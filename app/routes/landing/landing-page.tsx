...
export default function MainLayout() {
  return (
    <>
      ...
      <section
        className={cn(
          `container flex flex-col items-center gap-4 mx-auto px-8 mb-32`,
        )}
      >
        <h1 className="text-xl md:text-2xl font-medium">What is Kandiction?</h1>
      ...
      <footer className="p-4 w-full flex flex-col items-center gap-8">
